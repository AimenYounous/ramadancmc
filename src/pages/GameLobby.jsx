...
const GameLobby = () => {
    ...
    return (
        <div className="min-h-screen relative flex flex-col items-center p-6 text-center overflow-hidden" dir="rtl">
            ...
            {/* Header Content - Compacted */}
            <motion.div
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.8 }}
                className="z-10 mb-12 text-center mt-8"
            >
                <p className="text-gray-400 text-lg max-w-md mx-auto m-0">
                    اختر التحدي الذي تفضله واستمتع برحلة المعرفة والإيمان
                </p>
            </motion.div>
                        ...
                        <div className="relative bg-[rgba(20,30,25,0.7)] backdrop-blur-2xl p-8 rounded-[32px] border border-[rgba(255,255,255,0.1)] shadow-2xl overflow-hidden transition-all duration-300 group-hover:-translate-y-2 group-hover:border-[rgba(218,165,32,0.3)]">
                            ...
                            <div className="relative z-10 flex flex-col items-center">
                                ...
                                <div className="space-y-1 mb-4">
                                    ...
                                    <p className="text-[var(--color-accent)] text-sm font-bold tracking-widest opacity-80 uppercase">
                                        {game.subtitle}
                                    </p>
                                </div>
                                ...
                                <div className="w-full flex items-center justify-between pt-6 border-t border-[rgba(255,255,255,0.05)]">
                                    <div className="flex items-center gap-2">
                                        <FaStar className="text-yellow-500 text-xs" />
                                        <span className="text-xs text-gray-400">الصعوبة: {game.difficulty}</span>
                                    </div>
