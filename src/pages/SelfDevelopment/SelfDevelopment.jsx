    ...
    return (
        <div className="min-h-screen bg-[var(--color-bg)] perspective-container overflow-x-hidden relative flex flex-col" dir="rtl">
            ...
            <div className="flex-1 relative z-10 w-full flex justify-center items-center">
                <div className="w-full max-w-4xl px-6 py-12 md:py-16 flex flex-col gap-12">
                    {/* Progress Tracker */}
                    <motion.div
                        initial={{ opacity: 0, y: -20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="mb-12 p-6 bg-white/5 backdrop-blur-md rounded-2xl border border-[var(--color-accent)]/20 shadow-xl w-full"
                    >
